...
prdprnm VARCHAR(20) PRIMARY KEY,
...
prdprnm VARCHAR(20),
FOREIGN KEY(prdprnm) REFERENCES Refugiado (prdprnm)
);
...
ALTER TABLE Voluntario ADD FOREIGN KEY(id_pessoa) REFERENCES Pessoa (id_pessoa);
ALTER TABLE Empresa ADD FOREIGN KEY(id_endereco) REFERENCES Endereco (id_endereco);
ALTER TABLE Emprego ADD FOREIGN KEY(prdprnm) REFERENCES Refugiado (prdprnm);
...
ALTER TABLE Saude ADD FOREIGN KEY(cfp) REFERENCES Psicologo (cfp);
ALTER TABLE Saude ADD FOREIGN KEY(cip) REFERENCES  Enfermeiro (cip);
ALTER TABLE Saude ADD FOREIGN KEY(rntp) REFERENCES Terapeuta (rntp);
ALTER TABLE Saude ADD FOREIGN KEY(crn) REFERENCES Nutricionista (crn);
ALTER TABLE Saude ADD FOREIGN KEY(crefito) REFERENCES Fisioterapeuta (crefito);
ALTER TABLE Saude ADD FOREIGN KEY(crm) REFERENCES Medico (crm);
